...
class AlbumImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create album_image" do
    assert_difference("AlbumImage.count") do
      post album_images_url, params: { album_image: { album_id: @album_image.album_id, image_id: @album_image.image_id } }
    end
  ...
  test "should update album_image" do
    patch album_image_url(@album_image), params: { album_image: { album_id: @album_image.album_id, image_id: @album_image.image_id } }
